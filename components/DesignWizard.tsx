    ...
    return (
        <div className="max-w-7xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                {/* Left Sidebar - Vertical Steps (visible on lg+) */}
                        ...
                        {steps.map((step) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left flex items-start gap-3 p-3 rounded-xl transition-all ${isCurrent
                                        ? 'bg-emerald-50'
                                        : isClickable
                                            ? 'hover:bg-gray-50'
                                ...
                                >
                                    ...
                                    <div>
                                        <p className={`font-semibold text-sm ${isCurrent ? 'text-emerald-700' : 'text-gray-800'
                                            }`}>
                                            {step.title}
                                        </p>
                                    ...
                                    <div className="space-y-8">
                                        {Object.entries(DesignStyleGroups).map(([groupName, styles]) => (
                                            <div key={groupName} className="space-y-4">
                                                <h3 className="text-sm font-bold text-gray-600 uppercase tracking-wider border-b border-gray-100 pb-2">
                                                    {groupName}
                                                </h3>
