        ...
        <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-black selection:text-white">
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
                    {/* Left decorative image - landscape design */}
                    <div className="absolute left-0 top-0 w-1/3 h-full opacity-20">
                        <img
                            src={styleReferences[0]?.imageUrl || '/demo_clips/scene_2_ideation.jpg'}
                            alt=""
                            className="w-full h-full object-cover"
                        />
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent to-slate-900" />
                    </div>
                    {/* Right decorative image - 2D plan */}
                    <div className="absolute right-0 bottom-0 w-1/3 h-full opacity-15">
                        <img
                            src={styleReferences[2]?.imageUrl || '/demo_clips/scene_3_design.jpg'}
                            alt=""
                            className="w-full h-full object-cover"
                        />
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
                            Are You a <span className="font-semibold text-amber-400">Designer</span>?
                        </h2>
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
                            Join AutoScape as a professional and transform how you work with clients
                        </p>
                    </div>

                    {/* Benefits Grid with Image Backgrounds */}
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-amber-500/50 transition-all group overflow-hidden">
                            {/* Background decorative image */}
                            <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                                <img src={styleReferences[1]?.imageUrl} alt="" className="w-full h-full object-cover" />
                            </div>
                        ...
                        <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-amber-500/50 transition-all group overflow-hidden">
                            <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                                <img src={styleReferences[3]?.imageUrl} alt="" className="w-full h-full object-cover" />
                            </div>
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-amber-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-amber-500/30 transition-colors">
                                    <svg className="w-7 h-7 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <h3 className="text-xl font-semibold text-white mb-3">Find New Clients</h3>
                                <p className="text-gray-400 font-light leading-relaxed">
                        ...
                        <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-amber-500/50 transition-all group overflow-hidden">
                            <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity">
                                <img src={styleReferences[5]?.imageUrl} alt="" className="w-full h-full object-cover" />
                            </div>
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-amber-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-amber-500/30 transition-colors">
                                    <svg className="w-7 h-7 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <h3 className="text-xl font-semibold text-white mb-3">Match Expectations</h3>
                                <p className="text-gray-400 font-light leading-relaxed">
                    ...
                    <div className="text-center">
                        <button
                            ...
                            className="px-10 py-4 bg-amber-500 hover:bg-amber-400 text-black font-semibold rounded-lg transition-all transform hover:scale-105 text-lg shadow-lg shadow-amber-500/25"
                        >
                            Join as a Designer
                        </button>
