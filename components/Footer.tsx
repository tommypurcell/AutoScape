            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                ...
                <div className="mb-8 pb-8 border-b border-green-800/50">
                    <div className="flex items-start gap-3 max-w-4xl mx-auto">
                        ...
                        <div className="text-base text-green-100/80 leading-relaxed">
                            <p className="font-semibold text-green-100 mb-1">AI-Generated Content Disclaimer</p>
                            <p>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="text-center md:text-left">
                        <span className="text-2xl font-bold tracking-tight">AutoScape</span>
                        <p className="text-base text-green-100/70 mt-2 font-light max-w-xs">
                            Architectural Artificial Intelligence for the Modern Era.
                        </p>
                    </div>
                    <div className="flex gap-8 text-base font-medium text-green-100/80">
                    ...
                    <div className="text-base text-green-100/70 font-mono">
                        © 2025 AutoScape Inc.
                    </div>
                </div>
            </div>
