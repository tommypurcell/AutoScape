            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-lg font-semibold text-base transition-all transform active:scale-[0.98] mt-auto disabled:opacity-50 disabled:cursor-not-allowed ${
                    tier.highlight
