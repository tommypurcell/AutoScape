...
export const styleImages: Record<string, string> = {
  // Modern & Contemporary
  [DesignStyle.MODERN]: "/images/styles/modern.png", // Clear modern garden with concrete/grass
  ...
  // Regional & Cultural
  [DesignStyle.JAPANESE]: "/images/styles/japanese.png", // Classic raked sand zen garden
  ...
  [DesignStyle.NATIVE]: "/images/styles/native.png", // Wildflower meadow garden
  [DesignStyle.POLLINATOR]: "https://m.media-amazon.com/images/I/71aJ9Ab0JtL._AC_SX679_.jpg",
  [DesignStyle.PERMACULTURE]: "/images/styles/permaculture.png",
  [DesignStyle.RAIN_GARDEN]: "https://bloomyheaven.com/wp-content/uploads/2025/01/Stepped-Rain-Garden.jpg",

  // Specialty Styles
  [DesignStyle.MID_CENTURY]: "/images/styles/midcentury.png", // Palm Springs desert modern garden
  [DesignStyle.RUSTIC]: "/images/styles/rustic.png",
